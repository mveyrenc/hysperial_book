...
module UrlHelper
  ...
  def hysperial_button_to(name = nil, options = nil, html_options = nil, &block)
    ...
    button = Shared::HeadlessButton::Component.new(submit: true, **html_options)
  ...
  def hysperial_link_to(name = nil, options = nil, html_options = nil, &block)
  ...
  def hysperial_mail_to(email_address, name = nil, html_options = {}, &block)
