...
ActiveRecord::Schema[8.1].define(version: 20_230_806_142_408) do
  ...
  create_table 'content_tags', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[name content_tag_family_id], name: 'index_content_tags_on_name_and_content_tag_family_id',
                                            unique: true
